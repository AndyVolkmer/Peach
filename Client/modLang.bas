...
SET_CHECK_ASK_CLOSING = "Pitai predi zatvarqne"
SET_CHECK_MINIMIZE = "Minimizirai Peach do butoni za burz izbor"
...
MSG_ANNOUNCE = "%f[%u announces]: %m"
MSG_TABLE_RELOAD = "%u zapochna prezarejdaneto na '%t' table. ( %i ) "
MSG_TABLE_CANT_RELOAD = "Tazi funkciq ne moje da bade prezaredena."
MSG_CONFIG_RELOAD = "%u zapochna prezarejdaneto na file ( %t )"
...
MSG_GM_FLAG_ENABLE = "[GM] flag vkulchen. Izpolzvai .gm off za da izkluchish."
MSG_GM_FLAG_DISABLE = "[GM] flag izkluchen. Izpolzvai .gm on za da vkluchish."
MSG_UNKNOWN_COMMAND = "Izpolzvana e nepoznata komanda."
MSG_MUTED = "Vashiqt glas e zaglushen."
...
MSG_ONLINE_TIME = "Vie ste online ot %t."
...
MSG_NOT_CHANNEL_LEADER = "Vie ne ste lider na tozi kanal."
